...
def update_meta(curs: cursor, target_name: str, full_code: str, schema: str, table_name: str) -> None:
    '''
...
def scd_new(curs: cursor, all_fields: str, full_code: str, table_name: str, pk: str) -> None:
    '''
...
def scd_upd(curs: cursor, all_fields: str, full_code: str, table_name: str, pk: str, fields_ne_cond: str) -> None:
    '''
...
def insert_transactions(curs: cursor, target_name: str, fields_str: str, full_code: str, table_name: str, load_date: str) -> None:
    '''
...
def target_hist(curs: cursor, target_name: str, fields_dts_str: str, load_date: str) -> None:
    '''
...
def view(curs: cursor, view_name: str, fields_str: str, target_name: str, load_date: str) -> None:
    '''
...
def target_update_new(curs: cursor, table_name: str, target_name: str, fields_str: str, load_date: str, full_code: str) -> None:
    '''
...
def target_update_upd(curs: cursor, table_name: str, target_name: str, fields_str: str, load_date: str, pk: str, full_code: str) -> None:
    '''
...
def target_update_del(curs: cursor, table_name: str, target_name: str, fields_str: str, load_date: str, pk: str, full_code: str) -> None:
    '''
